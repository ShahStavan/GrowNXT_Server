...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run GrowNXT Server Flask Application.")
    parser.add_argument("--host", type=str, default="0.0.0.0", help="Host IP address to bind server (default: 0.0.0.0)")
    ...
    app = create_app()
    logger.info("Launching GrowNXT API Server on http://%s:%d (Debug=%s)...", args.host, args.port, args.debug)
